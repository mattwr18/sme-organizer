...
ActiveRecord::Schema.define(version: 20_180_526_232_112) do
  ...
  create_table 'products_sales', id: false, force: :cascade do |t|
    ...
    t.index %w[product_id sale_id], name: 'index_products_sales_on_product_id_and_sale_id'
    t.index %w[sale_id product_id], name: 'index_products_sales_on_sale_id_and_product_id'
  end
